...
import type { Price as _Price, Product as _Product, Review as _Review, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: string, arg3: Price, arg4: string, arg5: string, arg6: string, arg7: bigint | null, arg8: Array<Review>, arg9: string | null, arg10: bigint | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(arg0, arg1, arg2, to_candid_Price_n3(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg7), arg8, to_candid_opt_n6(this._uploadFile, this._downloadFile, arg9), to_candid_opt_n7(this._uploadFile, this._downloadFile, arg10));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCart(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getNewsletterSubscriptions(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: string, arg2: string, arg3: Price, arg4: string, arg5: string, arg6: string, arg7: bigint | null, arg8: Array<Review>, arg9: string | null, arg10: bigint | null): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_Price_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Price): Price {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        savings: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.savings)),
        rating: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.rating)),
        price: from_candid_Price_n14(_uploadFile, _downloadFile, value.price),
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        discounted: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.discounted)),
...
function to_candid_Price_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Price): _Price {
...
function to_candid_record_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        discounted: value.discounted ? candid_some(value.discounted) : candid_none(),
        original: value.original
    };
}
